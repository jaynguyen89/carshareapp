...
<?= $this->Flash->render(); ?>
<div class="container">
    <div class="text-center teal-text darken-4"><h2><b>Add New Car: Step 3</b></h2></div>
    <div class="row">
                ...
                <div class="table" style="margin: 0;">
                    <table class="table-responsive" style="margin: 0;">
                        <tr id="traudio"><th scope="row">Audio</th>
                            <td><div class="row" style="width: 90%"><?php if (!$audioOptions) echo '<span class="chip bg-grey" style="margin: 2px">No suggestions</span>'; else foreach ($audioOptions as $audio): ?>
                                        <span class="chip bg-indigo" style="margin: 2px" id="<?= preg_replace('/\s+/', '', $audio); ?>"><a href="#" onclick="addToAudio(this)"><?= $audio; ?></a></span>
                                    <?php endforeach; ?></div>
                        ...
                        <tr id="trconv"><th scope="row">Convenience</th>
                            <td><div class="row" style="width: 90%"><?php if (!$convOptions) echo '<span class="chip" style="margin: 2px">No suggestions</span>'; else foreach ($convOptions as $conv): ?>
                                    <span class="chip bg-indigo" style="margin: 2px" id="<?= preg_replace('/\s+/', '', $conv); ?>"><a href="#" onclick="addToConv(this)"><?= $conv; ?></a></span>
                                    <?php endforeach; ?></div>
                        ...
                        <tr id="trsafe"><th scope="row">Safety</th>
                            <td><div class="row" style="width: 90%"><?php if (!$safetyOptions) echo '<span class="chip bg-grey" style="margin: 2px">No suggestions</span>'; else foreach ($safetyOptions as $safety): ?>
                                        <span class="chip bg-indigo" style="margin: 2px" id="<?= preg_replace('/\s+/', '', $safety); ?>"><a href="#" onclick="addToSafety(this)"><?= $safety; ?></a></span>
                                    <?php endforeach; ?></div>
                        ...
                        <tr id="trlivi"><th scope="row">Light & View</th>
                            <td><div class="row" style="width: 90%"><?php if (!$liviOptions) echo '<span class="chip bg-grey" style="margin: 2px">No suggestions</span>'; else foreach ($liviOptions as $livi): ?>
                                        <span class="chip bg-indigo" style="margin: 2px" id="<?= preg_replace('/\s+/', '', $livi); ?>"><a href="#" onclick="addToLivi(this)"><?= $livi; ?></a></span>
                                    <?php endforeach; ?></div>
                        ...
                        <tr id="trother"><th scope="row">Other Specs</th>
                            <td><div class="row" style="width: 90%"><?php if (!$otherOptions) echo '<span class="chip bg-grey" style="margin: 2px">No suggestions</span>'; else foreach ($otherOptions as $other): ?>
                                        <span class="chip bg-indigo" style="margin: 2px" id="<?= preg_replace('/\s+/', '', $other); ?>"><a href="#" onclick="addToOther(this)"><?= $other; ?></a></span>
                                    <?php endforeach; ?></div>
