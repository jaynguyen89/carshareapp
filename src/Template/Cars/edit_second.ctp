...
<?= $this->Flash->render(); ?>
<div class="container">
    <div class="text-center teal-text darken-4"><h2><b>Update Car Information: Step 2</b></h2></div>
    <div class="row">
            ...
            <div class="card-body">
                <div class="table" style="margin: 0;">
                    <table class="table-responsive" style="margin: 0;">
                        <tr><th scope="row">Drive Type</th><?php $i = 0; foreach ($driveOptions as $key => $value) if ($value == $car['drivetype']) {$i = $key; break;} ?>
                            <td colspan="2"><?= $this->Form->control('drivetype', ['value' => $i, 'class' => 'form-control', 'type' => 'select', 'options' => $driveOptions, 'label' => false, 'id' => 'drivetype']); ?></td></tr>
                        <tr><th scope="row">Engine Type</th><?php $i = 0; foreach ($engineOptions as $key => $value) if ($value == $car['enginetype']) {$i = $key; break;} ?>
                            <td><?= $this->Form->control('enginetype', ['value' => $i, 'class' => 'form-control', 'type' => 'select', 'options' => $engineOptions, 'label' => false, 'id' => 'enginetype']); ?></td>
                        ...
                        <tr><th scope="row">Induction</th><?php $i = 0; foreach ($inductOptions as $key => $value) if ($value == $car['induction']) {$i = $key; break;} ?>
                            <td><?= $this->Form->control('induction', ['value' => $i, 'class' => 'form-control', 'type' => 'select', 'options' => $inductOptions, 'label' => false, 'id' => 'induction']); ?></td>
                        ...
                        <tr><th scope="row">Engine Size (ml)</th>
                            <td colspan="2"><?= $this->Form->control('enginesize', ['value' => intval($car['enginesize']), 'class' => 'form-control', 'type' => 'number', 'label' => false, 'id' => 'enginesize', 'placeholder' => 'Engine volume is in milliliters (ml).', 'onchange' => 'checkButton()']); ?>
                                <p class="small" id="enginesizeEr" style="display: none"></p></td></tr>
                        <tr><th scope="row">Cylinder</th>
                            <td colspan="2"><?= $this->Form->control('cylinder', ['value' => intval($car['cylinder']), 'class' => 'form-control', 'type' => 'number', 'label' => false, 'id' => 'cylinder', 'value' => 2, 'onchange' => 'checkButton()']); ?>
                        ...
                        <tr><th scope="row">Power</th>
                            <td colspan="2"><div class="row" style="margin: 0">
                                    <div class="col-sm-4"><?= $this->Form->control('watt', ['value' => intval(substr($car['power'], 0, 3)), 'class' => 'form-control', 'type' => 'number', 'label' => false, 'id' => 'watt', 'placeholder' => 'Ex. 150', 'onchange' => 'checkButton()']); ?></div>
                                    <div class="col-sm-2 center bg-indigo" style="padding-top: 15px;">kW - At</div>
                                    <div class="col-sm-4"><?= $this->Form->control('round', ['value' => intval(substr($car['power'], 8, 4)), 'class' => 'form-control', 'type' => 'number', 'label' => false, 'id' => 'round', 'placeholder' => 'Ex. 5000', 'onchange' => 'checkButton()']); ?></div>
                        ...
                        <tr><th scope="row">Gear</th>
                            <td colspan="2"><?= $this->Form->control('gear', ['value' => intval($car['gear']), 'class' => 'form-control', 'type' => 'number', 'label' => false, 'id' => 'gear', 'value' => 2, 'onchange' => 'checkButton()']); ?>
                                <p class="small" id="gearEr" style="display: none"></p></td></tr>
                        <tr><th scope="row">Gear Type</th><?php $i = 0; foreach ($gearOptions as $key => $value) if ($value == $car['geartype']) {$i = $key; break;} ?>
                            <td><?= $this->Form->control('geartype', ['value' => $i, 'class' => 'form-control', 'type' => 'select', 'options' => $gearOptions, 'label' => false, 'id' => 'geartype']); ?></td>
                        ...
                        <tr><th scope="row">Fuel Consume</th>
                            <td colspan="2"><div class="row"><?php $toks = explode(' - ', $car['fuelconsume']); ?>
                                    <div class="col-sm-4"><?= $this->Form->control('average', ['value' => floatval($toks[0]), 'class' => 'form-control', 'placeholder' => 'Average Consumption', 'type' => 'number', 'step' => '0.1', 'label' => false, 'id' => 'average', 'required' => true, 'min' => 0, 'onchange' => 'checkButton()']); ?></div>
                                    <div class="col-sm-4"><?= $this->Form->control('rural', ['value' => floatval($toks[2]), 'class' => 'form-control', 'placeholder' => 'Consumption in Rural areas', 'type' => 'number', 'step' => '0.1', 'label' => false, 'id' => 'rural', 'required' => true, 'min' => 0, 'onchange' => 'checkButton()']); ?></div>
                                    <div class="col-sm-4"><?= $this->Form->control('urbane', ['value' => floatval($toks[1]), 'class' => 'form-control', 'placeholder' => 'Consumption in Urbane areas', 'type' => 'number', 'step' => '0.1', 'label' => false, 'id' => 'urbane', 'required' => true, 'min' => 0, 'onchange' => 'checkButton()']); ?></div>
