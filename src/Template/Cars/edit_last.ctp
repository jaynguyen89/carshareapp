...
<?= $this->Flash->render(); ?>
    <div class="container">
        <div class="text-center teal-text darken-4"><h2><b>Update Car Information: Step 5</b></h2></div>
        <div class="row">
            <div class="card horizontal" style="width: 100%">
                ...
                <div class="card-action">
                    <?= $this->Form->button(__('Finish'), ['class' => 'btn btn-lg btn-info lighten-2 waves-effect waves-light', 'id' => 'publish', 'type' => 'submit', 'style' => 'width: 200px;']); ?>
                    <?= $this->Form->end(); ?>
