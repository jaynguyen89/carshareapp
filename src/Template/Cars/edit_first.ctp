...
<?= $this->Flash->render(); ?>
<div class="container">
    <div class="text-center teal-text darken-4"><h2><b>Update Car Information: Step 1</b></h2></div>
    <div class="text-center"><div class="chip bg-red lighten-3" style="margin-bottom: 5px">Please Note: Car will be set unavailable by default after modification.<i class="close material-icons">close</i></div></div>
    <div class="text-center"><div class="chip bg-red lighten-3">You can republish it in `Revive`. Current rentals on this car won't be affected.<i class="close material-icons">close</i></div></div>
    <div class="row">
            ...
            <div class="card-body">
                <div class="table" style="margin: 0;">
                    <table class="table-responsive" style="margin: 0;">
                        <tr><th scope="row">Make</th><?php $i = 0; foreach ($makeOptions as $key => $value) if ($value == $car['make']) {$i = $key; break;} ?>
                            <td><?= $this->Form->control('make', ['class' => 'form-control', 'type' => 'select', 'options' => $makeOptions, 'value' => $i, 'label' => false, 'id' => 'make', 'onchange' => 'changeModel()']); ?></td>
                        ...
                        <tr><th scope="row">Model</th><?php $i = 0; foreach ($modelOptions as $mk => $options) {if ($mk == $car['make']) {foreach ($options as $key => $value) if ($value == $car['model']) {$i = $key; break;} break;}}?>
                            <td><?= $this->Form->control('model', ['class' => 'form-control', 'type' => 'select', 'options' => $modelOptions, 'value' => $i, 'label' => false, 'id' => 'model', 'onchange' => 'changeMake()']); ?></td>
                        ...
                        <tr><th scope="row">Year</th>
                            <td colspan="2"><?= $this->Form->control('year', ['class' => 'form-control', 'type' => 'number', 'value' => intval($car['year']), 'label' => false, 'id' => 'year', 'min' => 1990, 'max' => 2018, 'onchange' => 'checkButton()']); ?>
                                <p class="small" id="yearEr" style="display: none"></p></td></tr>
                        <tr><th scope="row">Color</th>
                            <td colspan="2"><div class="row">
                                    <div class="col-sm-4"><input type="radio" name="color" value="White" id="whiteradio" <?= $car['color'] == 'White' ? 'checked' : ''; ?>><label for="whiteradio" style="color: black;">Close to White</label></div>
                                    <div class="col-sm-4"><input type="radio" name="color" value="Black" id="blackradio" <?= $car['color'] == 'Black' ? 'checked' : ''; ?>><label for="blackradio" style="color: black;">Close to Black</label></div>
                                    <div class="col-sm-4"><input type="radio" name="color" value="Others" id="otherradio" <?= $car['color'] == 'Others' ? 'checked' : ''; ?>><label for="otherradio" style="color: black;">Other Colors</label></div>
                                </div></td></tr>
                        <tr><th scope="row">Transmission</th>
                            <td colspan="2"><div class="row">
                                    <div class="col-sm-4"><input type="radio" name="transmission" value="0" id="transauto" <?= $car['transmission'] == 0 ? 'checked' : ''; ?>><label for="transauto" style="color: black;">Auto</label></div>
                                    <div class="col-sm-4"><input type="radio" name="transmission" value="1" id="transmanu" <?= $car['transmission'] == 1 ? 'checked' : ''; ?>><label for="transmanu" style="color: black;">Manual</label></div>
                                    <div class="col-sm-4"><input type="radio" name="transmission" value="2" id="transmix" <?= $car['transmission'] == 2 ? 'checked' : ''; ?>><label for="transmix" style="color: black;">Dual</label></div>
                                </div></td></tr>
                        <tr><th scope="row">Body Type</th><?php $i = 0; foreach ($typeOptions as $key => $value) if ($value == $car['type']) {$i = $key; break;} ?>
                            <td><?= $this->Form->control('type', ['class' => 'form-control', 'type' => 'select', 'options' => $typeOptions, 'value' => $i, 'label' => false, 'id' => 'type', 'onchange' => 'validateForm()']); ?></td>
                        ...
                        <tr><th scope="row">Seats</th>
                            <td colspan="2"><?= $this->Form->control('seats', ['class' => 'form-control', 'type' => 'number', 'label' => false, 'id' => 'seats', 'value' => intval($car['seats']), 'min' => 1, 'max' => 100, 'onchange' => 'checkButton()']); ?>
                                <p class="small" id="seatEr" style="display: none"></p></td></tr>
                        <tr><th scope="row">Fuel Type</th><?php $i = 0; foreach ($fuelOptions as $key => $value) if ($value == $car['fuel']) {$i = $key; break;} ?>
                            <td><?= $this->Form->control('fuel', ['class' => 'form-control', 'type' => 'select', 'options' => $fuelOptions, 'value' => $i, 'label' => false, 'id' => 'fuel', 'onchange' => 'validateForm()']); ?></td>
                        ...
                        <tr><th scope="row">Odometer (km)</th>
                            <td colspan="2"><?= $this->Form->control('odometer', ['value' => intval($car['odometer']),'class' => 'form-control',  'placeholder' => 'Numbers without separators', 'type' => 'number', 'label' => false, 'id' => 'odometer', 'onchange' => 'checkButton()']); ?>
                                <p class="small" id="odoEr" style="color: orangered; display: none"></p></td></tr>
                        <tr><th scope="row">Dimensions (*)</th>
                            <td colspan="2"><div class="row"><?php $toks = explode(' mm x ', $car['measures']); $l = intval($toks[0]); $w = intval($toks[1]); $h = intval(substr($toks[2], 0, 4)); ?>
                                    <div class="col-sm-4"><?= $this->Form->control('length', ['value' => $l, 'class' => 'form-control', 'placeholder' => 'Length', 'type' => 'number', 'label' => false, 'id' => 'length', 'required' => true, 'min' => 0, 'onchange' => 'checkButton()']); ?></div>
                                    <div class="col-sm-4"><?= $this->Form->control('width', ['value' => $w, 'class' => 'form-control', 'placeholder' => 'Width', 'type' => 'number', 'label' => false, 'id' => 'width', 'required' => true, 'min' => 0, 'onchange' => 'checkButton()']); ?></div>
                                    <div class="col-sm-4"><?= $this->Form->control('height', ['value' => $h, 'class' => 'form-control', 'placeholder' => 'Height', 'type' => 'number', 'label' => false, 'id' => 'height', 'required' => true, 'min' => 0, 'onchange' => 'checkButton()']); ?></div>
